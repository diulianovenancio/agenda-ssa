...
if(!empty($id) && !empty($title) && !empty($color) && !empty($start) && !empty($end)){
	...
	$result_events = "UPDATE agenda_fullcalendar SET title='$title', color='$color', start='$start_sem_barra', end='$end_sem_barra', obs='$observ', modificado_em=NOW(), modificado_por='$user' WHERE id='$id'"; 
