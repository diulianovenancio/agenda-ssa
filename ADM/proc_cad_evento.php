...
if(!empty($title) && !empty($color) && !empty($start) && !empty($end)){
	...
	$result_events = "INSERT INTO agenda_fullcalendar (departamento, title, color, start, end, obs, criado_em, criado_por) VALUES ('cpd', '$title', '$color', '$start_sem_barra', '$end_sem_barra', '$observ', NOW(), '$user')";
